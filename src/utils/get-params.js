...
export const getQueryParams = () => {
  ...
  const q = params.get(queriesConst.q)
    ? decodeURIComponent(params.get(queriesConst.q))
    : '';
  const city = params.get(queriesConst.city)
    ? decodeURIComponent(params.get(queriesConst.city))
    : '';
  const county = params.get(queriesConst.county)
    ? decodeURIComponent(params.get(queriesConst.county))
    : '';
  const company = params.get(queriesConst.company)
    ? decodeURIComponent(params.get(queriesConst.company))
    : '';
